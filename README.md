...
3. **Create a Bootable USB Stick**
   ...
   - Consider using [Ventoy](https://www.ventoy.net/en/index.html "Just install ventoy on the usb and copy any number of iso files to it. You can boot easily from any of them") for flexibility.
